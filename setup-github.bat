@echo off
REM Candy Crucible Comic Forge - GitHub Setup Script for Windows

echo 🍬 Candy Crucible Comic Forge - GitHub Setup
echo ==========================================

REM Repository information
set REPO_NAME=candy-crucible-comic-forge
set REPO_DESCRIPTION=🍬 Candy Crucible Comic Forge - AI Toolkit Edition. Ultimate Sweet Apocalypse comic generation with advanced LoRA training, RAG context, and one-click installation.
